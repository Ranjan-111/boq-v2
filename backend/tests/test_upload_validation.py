...
class TestSniff:
    ...
    def test_pdf_magic_beats_wrong_extension(self):
        assert sniff_format(PDF, "drawing.txt") == "pdf"

    def test_dxf_by_markers(self):
    ...
    def test_dxf_without_entities_rejected(self):
        with pytest.raises(UploadRejected) as e:
...
class TestValidate:
    ...
    def test_unsanitizable_filename_rejected(self):
        with pytest.raises(UploadRejected):
    ...
    def test_content_addressed_key_is_stable(self):
    ...
    def test_dxf_uploads_clean(self):
